<script lang="ts">
	import { loginRemoteForm } from '$lib/remote/auth.remote';
...
<Card.Root class="mx-auto w-full max-w-sm">
	...
	<Card.Content>
		<form
			{...loginRemoteForm.preflight(Schema.standardSchemaV1(LoginFormSchema))}
			oninput={() => {
		...
		>
			<FieldGroup>
				{@const emailField = loginRemoteForm.fields.email}
				{@const passwordField = loginRemoteForm.fields.password}
				...
				<Field>
					...
					<FieldDescription class="text-center">
						<a href="/forgot_password" class="ms-auto inline-block text-sm underline">
